...
<p align="center">
  <img src="https://skillicons.dev/icons?i=react,ts,nextjs,redux,nodejs,express,firebase,docker,jest" />
</p>
...
- 🧠 Scenario Flow Builder — визуальный редактор сценариев (React, TypeScript, Canvas) · [GitHub](https://github.com/BrovkinArtem/scenario-flow-builder) · [Live demo]([https://vercel.com/artembrovkins-projects-7b886721/scenario-flow-builder/9ynfRyWry5RqMAFPsTJjcumz1AS4](https://scenario-flow-builder.vercel.app/scenarios))
